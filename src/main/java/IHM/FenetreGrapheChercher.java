...
public class FenetreGrapheChercher extends JFrame {
    ...
    public FenetreGrapheChercher (String newCheminFile, FenetrePrincipale newFenetrePrincipale, String newLieuDepart, String newLieuCherche) throws IOException, ExceptionAjListeGraphe {
        super ();
    ...
    public JPanel constrFenVisuel () throws IOException, ExceptionAjListeGraphe {
        ...
        graph = creationGraphe.creerGrapheChercher (lieuDepart, lieuCherche);
    ...
    public JPanel constrInformationsSurLeGraphe () {
        ...
        Graph getGraph = creationGraphe.getGraphChercher (lieuDepart, lieuCherche);
    ...
    public JPanel legende () {
        ...
        switch (lieuCherche) {
            case "Ville":
                ...
                JLabel recherche = new JLabel("Lieux cherchés : ville ");
                p.add(recherche);
                ...
                break;
            case "Restaurant":
                legendeRecherche = new ImageIcon("src/main/resources/mapPinSmall.png");
                recherche = new JLabel("Lieux cherchés : Restaurant ");
                p.add(recherche);
                recherche.setFont(new Font("Arial", Font.BOLD, 15));
                recherche.setForeground(Color.WHITE);
                recherche.setIcon(legendeRecherche);
            ...
            case "Loisir":
                legendeRecherche = new ImageIcon("src/main/resources/mapPinSmall.png");
                recherche = new JLabel("Lieux cherchés : Loisir ");
                p.add(recherche);
                recherche.setFont(new Font("Arial", Font.BOLD, 15));
                recherche.setForeground(Color.WHITE);
                recherche.setIcon(legendeRecherche);
        ...
        if (lieuCherche.equals ("Ville") != true) {
        ...
        if (lieuCherche.equals ("Restaurant") != true) {
        ...
        if (lieuCherche.equals ("Loisir") != true) {
